...
public partial class LitFragPage : Page
{
    ...
    private void EncryptButton_OnClick(object sender, RoutedEventArgs e)
    {
        ...
        var key = File.ReadAllText(_fileInfo.FullName);

        try
        {
            _textBox.Text = new LitFrag(key).Encrypt(_textBox.Text);
        }
        catch (Exception exc)
        {
            MessageBox.Show(
    ...
    private void DecryptButton_OnClick(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            _textBox.Text = new LitFrag(key).Decrypt(_textBox.Text);
        }
        catch (Exception exc)
        {
            MessageBox.Show(
    ...
    private void OpenKeyFile_OnClick(object sender, RoutedEventArgs e)
    {
        try
        {
    ...
    private void CloseKeyFile_OnClick(object sender, RoutedEventArgs e)
    {
        _fileInfo = null;
        FilePath.Text = "";
