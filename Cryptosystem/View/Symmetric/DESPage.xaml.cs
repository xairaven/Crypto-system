...
public partial class DESPage : Page
{
    ...
    private void EncryptButton_OnClick(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            _textBox.Text = new DES().Encrypt(_textBox.Text, dataMode, cipherMode, 
    ...
    private void DecryptButton_OnClick(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            _textBox.Text = new DES().Decrypt(_textBox.Text, dataMode, cipherMode, 
                KeyBox.Text.Trim(), IVBox.Text.Trim());
        }
        catch (Exception exception)
        {
    ...
    {
        using var provider = SysCrypto.DES.Create();
